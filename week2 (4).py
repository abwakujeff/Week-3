...
(1000×(0.7−0.3)), close to observed 422.  
...
**Key Insights:**  
In a 2D unbiased random walk, the mosquito doesn’t return to the origin but tends to drift outward gradually.  
...
500
​
 ≈22.36, matching the observed 22.66.
The variation (standard deviation) shows randomness in the mosquito's path—some runs end much farther than others.  
